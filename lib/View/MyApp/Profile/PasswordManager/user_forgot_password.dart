  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        Scaffold(
          ...
          bottomNavigationBar: Padding(
            ...
            child: PrimaryPinkButton(
                onTaped: getStorage.read("isDemoLogin") ?? false
                    ? () => displayToast(message: St.thisIsDemoUser.tr)
                    : () => userPasswordController.forgotPasswordByUser(),
                text: St.submit.tr),
          ),
          body: SafeArea(
              child: SizedBox(
        ...
        Obx(
          () => userPasswordController.forgotPasswordLoading.value ? ScreenCircular.blackScreenCircular() : const SizedBox(),
        ),
      ],
    );
  }
