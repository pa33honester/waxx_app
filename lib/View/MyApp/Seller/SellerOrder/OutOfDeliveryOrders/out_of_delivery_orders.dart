...
import 'out_of_delivered_order_details.dart';

class OutOfDeliveryOrders extends StatefulWidget {
  final String? startDate;
  final String? endDate;
  final String? status;

  const OutOfDeliveryOrders({super.key, this.startDate, this.endDate, this.status});

  @override
  State<OutOfDeliveryOrders> createState() => _OutOfDeliveryOrdersState();
}

class _OutOfDeliveryOrdersState extends State<OutOfDeliveryOrders> {
      ...
      child: Scaffold(
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            flexibleSpace: SimpleAppBarWidget(title: St.outOfDeliveredOrder.tr),
          ),
        ),
        body: SizedBox(
          height: Get.height,
                                ...
                                onTap: () {
                                  ...
                                  Get.to(
                                      () => OutOfDeliveryOrdersDetails(
                                            ...
                                            trackingId: orders.items![index].trackingId,
                                            trackingLink: orders.items![index].trackingLink,
