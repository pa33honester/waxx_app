...
class SellerForgotEnterOtp extends StatelessWidget {
  SellerForgotEnterOtp({super.key});
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                        ...
                        child: SizedBox(
                          ...
                          child: RichText(
                            ...
                            text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                    text: sellerCommonController.enterEmail.text,
                      ...
                      Padding(
                        ...
                        child: GetBuilder<UserPasswordController>(
                          builder: (controller) => Pinput(
                            controller: sellerCommonController.verifyOtpText,
                      ...
                      CommonSignInButton(
                          onTaped: () {
                            sellerCommonController.verifyOtp();
                          },
                      ...
                      Padding(
                        ...
                        child: DoNotAccount(
                            onTaped: () {
                              sellerCommonController.resendOtpBySeller();
                            },
        ...
        Obx(
          () => sellerCommonController.verifyOtpLoading.value || sellerCommonController.resendOtpLoading.value
